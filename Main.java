    ...
    public void stato() {                                                          //CONTROLLA//
        ...
        for (int i = 0; i < slots.size(); i++) {
            if (slots.get(i) instanceof veicolo.furgone) {
                System.out.println("Furgone: " + " " + slots.get(i).modello + " - " + slots.get(i).targa + " OWNER: " + slots.get(i).proprietario);
            } else if (slots.get(i) instanceof veicolo.moto) {
                System.out.println("Moto: " + " " + slots.get(i).modello + " - " + slots.get(i).targa + " OWNER: " + slots.get(i).proprietario);
            } else {
                System.out.println("Auto: " + " " + slots.get(i).modello + " - " + slots.get(i).targa + " OWNER: " + slots.get(i).proprietario);
            }
        }
        System.out.println("*Spazio Rimanente*"+rimanenti +"\n");
    }
